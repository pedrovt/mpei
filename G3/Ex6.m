...
% 6. A distribuição de Poisson é uma forma limite da distribuição binomial (quando n -> ? , p -> 0 e np
% permanece constante) e portanto pode ser usada para aproximar e simplificar os cálculos envolvidos com
% a binomial numa situação dessas.

% Num processo industrial de fabrico de chips, alguns aparecem defeituosos tornando-os inapropriados
% para comercialização. 

% É sabido que em média por cada mil chips há um defeituoso. Determine a probabilidade de numa amostra de 
% 8000 aparecerem 7 defeituosos. Compare os resultados usando a distribuição correcta e a aproximação de Poisson.
